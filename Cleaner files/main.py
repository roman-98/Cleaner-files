...
DAYS = 12		# Maximal age of file to stay, older will be deleted
FOLDERS = [
			"D:/1с",
			"D:/1c",
			"D:/beckup",
			...
			"D:/system",
			"E:/backup",                        # Shuvar
			"F:/SQL 1c beckup",                 # Zolochiv-Boryslav
			"D:/Sql beckup/Нова папка",         # Drogobych
			"D:/ходорів",                       # Hodoriv
			"D:/1c_B",                          # Kolomiya
			"D:/1C",                            # Galych
			"D:/1C",                            # Mazepy
			"D:/Sql beckup/1c",                 # Striy
			"D:/Sql beckup/system",             # Striy не кожен день бекапи
			"G:/backup",                        # Shpytalna
			"D:/Beckup/1c",                     # AC2
			"D:/Beckup/System",                 # AC2
			"D:/SQL beckup/1c",                 # Doroshenka
			"D:/beckup/1c",                     # Busk
			"D:/beckup/system",                 # Busk
			"D:/1c_beckup",                     # Brody
			"D:/1с_Beckup",                     # Levandivka Shyroka
			"D:/back_up",                       # Sudova Vishnya
		  ]
	...
	for path, dirs, files in os.walk(folder):
		for file in files:
			...
			if fileTime < ageTime:
				...
				TOTAL_DELETED_SIZE += sizeFile				# Count SUM of all free spase
